...
{
    public partial class Pengembalian1
    {
        ...
        public virtual KondisiKendaraan1 IdKondisiNavigation { get; set; }
        public virtual Peminjaman1 IdPeminjamanNavigation { get; set; }
    }
}
